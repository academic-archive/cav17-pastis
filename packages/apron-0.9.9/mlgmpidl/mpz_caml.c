...
value camlidl_mpz_mpz__set_str(
	value _v_ROP,
	value _v_STR,
	value _v_BASE)
{
...
value camlidl_mpz_mpz__init_set_str(
	value _v_STR,
	value _v_BASE)
{
  mpz_t OUTOUTOUT; mpz_ptr OUTTOUTTOUTT = OUTOUTOUT;; /*out*/
...
value camlidl_mpz_mpz__get_str(
	value _v_BASE,
	value _v_OP)
{
  int BASE; /*in*/
...
value camlidl_mpz_mpz_divexact(
	value _v_Q,
	value _v_N,
	value _v_D)
{
...
value camlidl_mpz_mpz__powm_ui(
	value _v_ROP,
	value _v_BASE,
	value _v_EXP,
	value _v_MOD)
...
value camlidl_mpz_mpz__sqrtrem(
	value _v_ROP1,
	value _v_ROP2,
	value _v_OP)
{
...
value camlidl_mpz_mpz_fits_int_p(
	value _v_OP)
{
  mpz_ptr OP; /*in*/
  int _res;
